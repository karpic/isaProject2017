...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/filmovi/bioskopi/*","/pozorista/*","/predstave/*","/sale","/sale/*","/user","/user/*","/confirm","/register","/bioskopi","/pozorista","/projekcije","/projekcije/filmovi/*","/filmovi/*","/bioskopi/*","/sale/projekcije/*","/projekcijePoz/predstave/*","/sale/projekcijePoz/*","/projekcijePoz/*");
